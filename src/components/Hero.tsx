...
const Hero = () => {
  return (
    <main className="flex min-h-[90vh] flex-col justify-center gap-5 bg-gradient-to-t from-[#dc85ff] via-[#fbf0ff] to-[#fafafa] py-[12rem]">
      <h1 className="subpixel-antialiased">
        Examine the Future Landscape of <br /> Employee Management Today.
      </h1>
